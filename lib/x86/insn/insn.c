 ...
 * 64-bit mode.
 */
static inline bool any_64bit_mode(struct ex_regs *regs)
{
	return true;
}

static void *get_addr_ref_64(struct insn *insn, struct ex_regs *regs)
{
	...
	linear_addr = (unsigned long)eff_addr + 0;
